(ns raml-parser-toolbelt.canonical-form
  #?(:cljs (:require-macros [raml-parser-toolbelt.utils-macros :refer [check]]))
  (:require #?(:clj [raml-parser-toolbelt.utils-macros-clj :refer [check]])
            [clojure.string :as string]
            [clojure.set :as set]
            [raml-parser-toolbelt.utils :refer [error]]))
