...
var args16655 = [];
var len__7291__auto___16660 = arguments.length;
var i__7292__auto___16661 = (0);
while(true){
if((i__7292__auto___16661 < len__7291__auto___16660)){
args16655.push((arguments[i__7292__auto___16661]));

var G__16662 = (i__7292__auto___16661 + (1));
i__7292__auto___16661 = G__16662;
continue;
} else {
}
break;
...
var vec__16658 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__16658,(0),null);
var end = cljs.core.nth.call(null,vec__16658,(1),null);
...
var vec__16665 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__16665,(0),null);
var end = cljs.core.nth.call(null,vec__16665,(1),null);
...
var G__16666 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__16666;
continue;
}
...
var args16667 = [];
var len__7291__auto___16674 = arguments.length;
var i__7292__auto___16675 = (0);
while(true){
if((i__7292__auto___16675 < len__7291__auto___16674)){
args16667.push((arguments[i__7292__auto___16675]));

var G__16676 = (i__7292__auto___16675 + (1));
i__7292__auto___16675 = G__16676;
continue;
} else {
}
break;
...
var G__16671 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16672 = G__16671;
var parse = cljs.core.nth.call(null,vec__16672,(0),null);
var end = cljs.core.nth.call(null,vec__16672,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16672,(2),null);
var selection = vec__16672;
...
var vec__16673 = G__16671__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16673,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16673,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16673,(2),null);
var selection__$1 = vec__16673;
...
var G__16678 = cljs.core.long$.call(null,end__$1);
var G__16679 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16680 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16678;
parses__$1 = G__16679;
G__16671__$1 = G__16680;
continue;
...
var args16681 = [];
var len__7291__auto___16688 = arguments.length;
var i__7292__auto___16689 = (0);
while(true){
if((i__7292__auto___16689 < len__7291__auto___16688)){
args16681.push((arguments[i__7292__auto___16689]));

var G__16690 = (i__7292__auto___16689 + (1));
i__7292__auto___16689 = G__16690;
continue;
} else {
}
break;
...
var G__16685 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16686 = G__16685;
var parse = cljs.core.nth.call(null,vec__16686,(0),null);
var end = cljs.core.nth.call(null,vec__16686,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16686,(2),null);
var selection = vec__16686;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__16685__$1 = G__16685;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__16687 = G__16685__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16687,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16687,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16687,(2),null);
var selection__$1 = vec__16687;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__16692 = cljs.core.long$.call(null,end__$1);
var G__16693 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16694 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16692;
parses__$1 = G__16693;
G__16685__$1 = G__16694;
continue;
...
args16695.push((arguments[i__7292__auto___16703]));
...
var index__$1 = cljs.core.long$.call(null,index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__16699 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16700 = G__16699;
var parse = cljs.core.nth.call(null,vec__16700,(0),null);
var end = cljs.core.nth.call(null,vec__16700,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16700,(2),null);
var selection = vec__16700;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__16699__$1 = G__16699;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__16701 = G__16699__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16701,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16701,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16701,(2),null);
var selection__$1 = vec__16701;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__16706 = cljs.core.long$.call(null,end__$1);
var G__16707 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16708 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16706;
parses__$1 = G__16707;
G__16699__$1 = G__16708;
continue;
...
var args16709 = [];
var len__7291__auto___16712 = arguments.length;
var i__7292__auto___16713 = (0);
while(true){
if((i__7292__auto___16713 < len__7291__auto___16712)){
args16709.push((arguments[i__7292__auto___16713]));

var G__16714 = (i__7292__auto___16713 + (1));
i__7292__auto___16713 = G__16714;
continue;
} else {
}
break;
...
var G__16717 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);
switch (G__16717) {
case "enlive":
...
//# sourceMappingURL=repeat.js.map?rel=1471427568428