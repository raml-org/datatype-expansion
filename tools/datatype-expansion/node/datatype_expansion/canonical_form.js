...
var pred__20713 = cljs.core.count.call(null,values);
var expr__20714 = cljs.core._EQ_;
if(cljs.core.truth_(pred__20713.call(null,(0),expr__20714))){
return null;
} else {
if(cljs.core.truth_(pred__20713.call(null,(1),expr__20714))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__20713.call(null,(2),expr__20714))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__20714)].join('')));
}
}
}
}));
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__20716 = cljs.core.count.call(null,values);
var expr__20717 = cljs.core._EQ_;
if(cljs.core.truth_(pred__20716.call(null,(0),expr__20717))){
return null;
} else {
if(cljs.core.truth_(pred__20716.call(null,(1),expr__20717))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__20716.call(null,(2),expr__20717))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__20719 = cljs.core.count.call(null,values);
var expr__20720 = cljs.core._EQ_;
if(cljs.core.truth_(pred__20719.call(null,(0),expr__20720))){
return null;
} else {
if(cljs.core.truth_(pred__20719.call(null,(1),expr__20720))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__20719.call(null,(2),expr__20720))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__20720)].join('')));
}
}
}
}));
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__20722 = cljs.core.count.call(null,values);
var expr__20723 = cljs.core._EQ_;
if(cljs.core.truth_(pred__20722.call(null,(0),expr__20723))){
return null;
} else {
if(cljs.core.truth_(pred__20722.call(null,(1),expr__20723))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__20722.call(null,(2),expr__20723))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__20723)].join('')));
}
}
}
}));
...
var G__20725 = cljs.core.assoc.call(null,merged,property,(function (){var or__6216__auto__ = property_super;
...
var G__20726 = cljs.core.rest.call(null,properties);
merged = G__20725;
properties = G__20726;
continue;
} else {
var G__20727 = cljs.core.assoc.call(null,merged,property,datatype_expansion.canonical_form.lt_restriction.call(null,property,property_super,property_sub));
var G__20728 = cljs.core.rest.call(null,properties);
merged = G__20727;
properties = G__20728;
continue;
}
...
datatype_expansion.canonical_form.consistency_checks = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"numProperties","numProperties",-85472948),(function (p__20729){
...
var minProperties = cljs.core.get.call(null,map__20730__$1,new cljs.core.Keyword(null,"minProperties","minProperties",100355152));
var maxProperties = cljs.core.get.call(null,map__20730__$1,new cljs.core.Keyword(null,"maxProperties","maxProperties",1289793027));
...
}),new cljs.core.Keyword(null,"length","length",588987862),(function (p__20732){
var map__20733 = p__20732;
var map__20733__$1 = ((((!((map__20733 == null)))?((((map__20733.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20733.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20733):map__20733);
var minLength = cljs.core.get.call(null,map__20733__$1,new cljs.core.Keyword(null,"minLength","minLength",-1538722770));
var maxLength = cljs.core.get.call(null,map__20733__$1,new cljs.core.Keyword(null,"maxLength","maxLength",-1633020073));
...
}),new cljs.core.Keyword(null,"size","size",1098693007),(function (p__20735){
...
var minimum = cljs.core.get.call(null,map__20736__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.call(null,map__20736__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
...
}),new cljs.core.Keyword(null,"numItems","numItems",-1505478382),(function (p__20738){
...
var input = map__20739__$1;
var minItems = cljs.core.get.call(null,map__20739__$1,new cljs.core.Keyword(null,"minItems","minItems",1950622069));
var maxItems = cljs.core.get.call(null,map__20739__$1,new cljs.core.Keyword(null,"maxItems","maxItems",576652798));
...
var seq__20747_20753 = cljs.core.seq.call(null,datatype_expansion.canonical_form.consistency_checks);
var chunk__20748_20754 = null;
var count__20749_20755 = (0);
var i__20750_20756 = (0);
while(true){
if((i__20750_20756 < count__20749_20755)){
var vec__20751_20757 = cljs.core._nth.call(null,chunk__20748_20754,i__20750_20756);
var name_20758 = cljs.core.nth.call(null,vec__20751_20757,(0),null);
var check_fn_20759 = cljs.core.nth.call(null,vec__20751_20757,(1),null);
check_fn_20759.call(null,merged);

var G__20760 = seq__20747_20753;
var G__20761 = chunk__20748_20754;
var G__20762 = count__20749_20755;
var G__20763 = (i__20750_20756 + (1));
seq__20747_20753 = G__20760;
chunk__20748_20754 = G__20761;
count__20749_20755 = G__20762;
i__20750_20756 = G__20763;
continue;
} else {
var temp__4657__auto___20764 = cljs.core.seq.call(null,seq__20747_20753);
if(temp__4657__auto___20764){
var seq__20747_20765__$1 = temp__4657__auto___20764;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20747_20765__$1)){
var c__7027__auto___20766 = cljs.core.chunk_first.call(null,seq__20747_20765__$1);
var G__20767 = cljs.core.chunk_rest.call(null,seq__20747_20765__$1);
var G__20768 = c__7027__auto___20766;
var G__20769 = cljs.core.count.call(null,c__7027__auto___20766);
var G__20770 = (0);
seq__20747_20753 = G__20767;
chunk__20748_20754 = G__20768;
count__20749_20755 = G__20769;
i__20750_20756 = G__20770;
continue;
} else {
var vec__20752_20771 = cljs.core.first.call(null,seq__20747_20765__$1);
var name_20772 = cljs.core.nth.call(null,vec__20752_20771,(0),null);
var check_fn_20773 = cljs.core.nth.call(null,vec__20752_20771,(1),null);
check_fn_20773.call(null,merged);

var G__20774 = cljs.core.next.call(null,seq__20747_20765__$1);
var G__20775 = null;
var G__20776 = (0);
var G__20777 = (0);
seq__20747_20753 = G__20774;
chunk__20748_20754 = G__20775;
count__20749_20755 = G__20776;
i__20750_20756 = G__20777;
continue;
}
} else {
}
...
var type = cljs.core.get.call(null,map__20780__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
return cljs.core.assoc.call(null,type,new cljs.core.Keyword(null,"properties","properties",685819552),p1__20783_SHARP_);
});})(properties,union_values))
,cljs.core.mapv.call(null,((function (properties,union_values){
return (function (p1__20782_SHARP_){
return cljs.core.assoc.call(null,properties,property_name,p1__20782_SHARP_);
});})(properties,union_values))
,union_values));
}),accum));
});
...
var property_name = cljs.core.nth.call(null,vec__20785,(0),null);
var property_value = cljs.core.nth.call(null,vec__20785,(1),null);
...
var vec__20786 = cljs.core.first.call(null,properties__$2);
var name = cljs.core.nth.call(null,vec__20786,(0),null);
var value = cljs.core.nth.call(null,vec__20786,(1),null);
...
var G__20787 = cljs.core.rest.call(null,properties__$2);
var G__20788 = datatype_expansion.canonical_form.expand_property.call(null,accum__$1,name,canonical_value);
properties__$2 = G__20787;
accum__$1 = G__20788;
continue;
} else {
var G__20789 = cljs.core.rest.call(null,properties__$2);
var G__20790 = datatype_expansion.canonical_form.append_property.call(null,accum__$1,name,canonical_value);
properties__$2 = G__20789;
accum__$1 = G__20790;
continue;
}
}
...
var type = cljs.core.first.call(null,cljs.core.filter.call(null,cljs.core.some_QMARK_,cljs.core.map.call(null,(function (p1__20791_SHARP_){
try{return datatype_expansion$canonical_form$find_class.call(null,p1__20791_SHARP_);
...
var sub_type__$1 = (function (){var pred__20794 = cljs.core._EQ_;
var expr__20795 = super_type_class;
if(cljs.core.truth_(pred__20794.call(null,"array",expr__20795))){
...
if(cljs.core.truth_(pred__20794.call(null,"object",expr__20795))){
...
if(cljs.core.truth_(pred__20794.call(null,"union",expr__20795))){
...
var super_type_class = datatype_expansion.canonical_form.find_class.call(null,node);
var sub_type = cljs.core.assoc.call(null,node,new cljs.core.Keyword(null,"type","type",1174270348),super_type_class);
var sub_type__$1 = (function (){var pred__20797 = cljs.core._EQ_;
var expr__20798 = super_type_class;
if(cljs.core.truth_(pred__20797.call(null,"array",expr__20798))){
return cljs.core.assoc.call(null,sub_type,new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.get.call(null,sub_type,new cljs.core.Keyword(null,"items","items",1031954938),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),"any"], null)));
} else {
if(cljs.core.truth_(pred__20797.call(null,"object",expr__20798))){
...
if(cljs.core.truth_(pred__20797.call(null,"union",expr__20798))){
return cljs.core.assoc.call(null,sub_type,new cljs.core.Keyword(null,"of","of",-2075414212),cljs.core.get.call(null,sub_type,new cljs.core.Keyword(null,"of","of",-2075414212),cljs.core.PersistentVector.EMPTY));
} else {
return sub_type;
}
...
//# sourceMappingURL=canonical_form.js.map?rel=1471427571056