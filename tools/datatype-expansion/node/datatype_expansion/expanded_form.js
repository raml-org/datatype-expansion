...
return cljs.core.not_EQ_.call(null,p1__16845_SHARP_,new cljs.core.Keyword(null,"TYPE_EXPRESSION","TYPE_EXPRESSION",260003064));
});})(ast,context))
,ast);
...
var G__16857 = cljs.core.first.call(null,type);
var G__16858 = context;
ast = G__16857;
context = G__16858;
continue;
} else {
var pred__16852 = cljs.core._EQ_;
var expr__16853 = cljs.core.first.call(null,type);
if(cljs.core.truth_(pred__16852.call(null,new cljs.core.Keyword(null,"UNION_TYPE","UNION_TYPE",-1311432052),expr__16853))){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"union",new cljs.core.Keyword(null,"of","of",-2075414212),cljs.core.mapv.call(null,((function (ast,context,pred__16852,expr__16853,type){
return (function (p1__16846_SHARP_){
return datatype_expansion$expanded_form$ast__GT_type.call(null,p1__16846_SHARP_,context);
});})(ast,context,pred__16852,expr__16853,type))
,cljs.core.rest.call(null,type))], null);
} else {
if(cljs.core.truth_(pred__16852.call(null,new cljs.core.Keyword(null,"SCALAR_TYPE","SCALAR_TYPE",-784669066),expr__16853))){
...
if(cljs.core.truth_(pred__16852.call(null,new cljs.core.Keyword(null,"ARRAY_TYPE","ARRAY_TYPE",-473571449),expr__16853))){
...
if(cljs.core.truth_(pred__16852.call(null,new cljs.core.Keyword(null,"TYPE_NAME","TYPE_NAME",-245619732),expr__16853))){
var ref_type = cljs.core.first.call(null,cljs.core.mapv.call(null,cljs.core.last,cljs.core.filter.call(null,((function (ast,context,pred__16852,expr__16853,type){
return (function (p__16855){
var vec__16856 = p__16855;
var k = cljs.core.nth.call(null,vec__16856,(0),null);
var v = cljs.core.nth.call(null,vec__16856,(1),null);
...
datatype_expansion.expanded_form.check_required = (function datatype_expansion$expanded_form$check_required(p__16861){
var map__16866 = p__16861;
...
var object = map__16866__$1;
var properties = cljs.core.get.call(null,map__16866__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
return cljs.core.assoc.call(null,object,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,((function (map__16866,map__16866__$1,object,properties){
return (function (p__16868){
var vec__16869 = p__16868;
var k = cljs.core.nth.call(null,vec__16869,(0),null);
var v = cljs.core.nth.call(null,vec__16869,(1),null);
...
});})(map__16866,map__16866__$1,object,properties))
...
return cljs.core.assoc.call(null,node,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__16872){
var vec__16873 = p__16872;
var k = cljs.core.nth.call(null,vec__16873,(0),null);
var v = cljs.core.nth.call(null,vec__16873,(1),null);
...
var type_node__$1 = (((cljs.core.map_QMARK_.call(null,type_node)) && (cljs.core.some_QMARK_.call(null,new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(type_node))))?cljs.core.assoc.call(null,type_node,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__16880){
var vec__16881 = p__16880;
var k = cljs.core.nth.call(null,vec__16881,(0),null);
var v = cljs.core.nth.call(null,vec__16881,(1),null);
...
return datatype_expansion$expanded_form$expanded_form.call(null,p1__16874_SHARP_,context);
});})(type_node__$1,type))
...
return (function (p__16882){
var vec__16883 = p__16882;
var prop_name = cljs.core.nth.call(null,vec__16883,(0),null);
var type__$1 = cljs.core.nth.call(null,vec__16883,(1),null);
...
//# sourceMappingURL=expanded_form.js.map?rel=1471427568879