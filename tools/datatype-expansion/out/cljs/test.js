...
var args9585 = [];
var len__7095__auto___9589 = arguments.length;
var i__7096__auto___9590 = (0);
while(true){
if((i__7096__auto___9590 < len__7095__auto___9589)){
args9585.push((arguments[i__7096__auto___9590]));

var G__9591 = (i__7096__auto___9590 + (1));
i__7096__auto___9590 = G__9591;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,G__9588,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9588;
}
});
...
var or__6020__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7095__auto___9596 = arguments.length;
var i__7096__auto___9597 = (0);
while(true){
if((i__7096__auto___9597 < len__7095__auto___9596)){
args__7102__auto__.push((arguments[i__7096__auto___9597]));

var G__9598 = (i__7096__auto___9597 + (1));
i__7096__auto___9597 = G__9598;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7103__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9593){
var G__9594 = cljs.core.first.call(null,seq9593);
var seq9593__$1 = cljs.core.next.call(null,seq9593);
var G__9595 = cljs.core.first.call(null,seq9593__$1);
var seq9593__$2 = cljs.core.next.call(null,seq9593__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__9594,G__9595,seq9593__$2);
});
...
var file = cljs.core.get.call(null,map__9602__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9602__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9602__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9602,map__9602__$1,file,line,column){
return (function (p1__9599_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9599_SHARP_));
});})(map__9602,map__9602__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__6945__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__6945__auto__,prefer_table__6946__auto__,method_cache__6947__auto__,cached_hierarchy__6948__auto__,hierarchy__6949__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6020__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6020__auto__)){
return or__6020__auto__;
} else {
...
var temp__4657__auto___9604 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___9604)){
var message_9605 = temp__4657__auto___9604;
cljs.core.println.call(null,message_9605);
} else {
}
...
var temp__4657__auto___9606 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___9606)){
var message_9607 = temp__4657__auto___9606;
cljs.core.println.call(null,message_9607);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6008__auto__ = typeof exception.stack === 'string';
if(and__6008__auto__){
var G__9613 = exception.stack;
var G__9613__$1 = (((G__9613 == null))?null:clojure.string.split_lines.call(null,G__9613));
var G__9613__$2 = (((G__9613__$1 == null))?null:cljs.core.get.call(null,G__9613__$1,depth));
if((G__9613__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9613__$2);
}
} else {
...
var vec__9614 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9614,(0),null);
var column = cljs.core.nth.call(null,vec__9614,(1),null);
var vec__9615 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9615,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9615,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9615,(2),null);
...
var m__$1 = (function (){var G__9617 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__9617) {
case "fail":
...
var G__9623 = (function (){var G__9622 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9622);
} else {
return G__9622;
}
})();
...
return cljs.core.vary_meta.call(null,G__9625,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e9628){var e = e9628;
var G__9629 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__9629) {
...
var vec__9632 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9632,(0),null);
var types = vec__9632;
...
return cljs.core.map.call(null,(function (p__9640){
var vec__9641 = p__9640;
var ns = cljs.core.nth.call(null,vec__9641,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9641,(1),null);
return ((function (vec__9641,ns,vars__$1){
return (function (){
...
var G__9642 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__9642) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1){
return (function (){
var seq__9643 = cljs.core.seq.call(null,vars__$1);
var chunk__9644 = null;
var count__9645 = (0);
var i__9646 = (0);
while(true){
if((i__9646 < count__9645)){
var v = cljs.core._nth.call(null,chunk__9644,i__9646);
var temp__4657__auto___9648 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___9648)){
var t_9649 = temp__4657__auto___9648;
each_fixture_fn.call(null,((function (seq__9643,chunk__9644,count__9645,i__9646,t_9649,temp__4657__auto___9648,v,each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9649)));
});})(seq__9643,chunk__9644,count__9645,i__9646,t_9649,temp__4657__auto___9648,v,each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1))
);
} else {
}

var G__9650 = seq__9643;
var G__9651 = chunk__9644;
var G__9652 = count__9645;
var G__9653 = (i__9646 + (1));
seq__9643 = G__9650;
chunk__9644 = G__9651;
count__9645 = G__9652;
i__9646 = G__9653;
...
var c__6831__auto__ = cljs.core.chunk_first.call(null,seq__9643__$1);
var G__9654 = cljs.core.chunk_rest.call(null,seq__9643__$1);
var G__9655 = c__6831__auto__;
var G__9656 = cljs.core.count.call(null,c__6831__auto__);
var G__9657 = (0);
seq__9643 = G__9654;
chunk__9644 = G__9655;
count__9645 = G__9656;
...
var v = cljs.core.first.call(null,seq__9643__$1);
var temp__4657__auto___9658__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___9658__$1)){
var t_9659 = temp__4657__auto___9658__$1;
each_fixture_fn.call(null,((function (seq__9643,chunk__9644,count__9645,i__9646,t_9659,temp__4657__auto___9658__$1,v,seq__9643__$1,temp__4657__auto__,each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9659)));
});})(seq__9643,chunk__9644,count__9645,i__9646,t_9659,temp__4657__auto___9658__$1,v,seq__9643__$1,temp__4657__auto__,each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1))
);
} else {
}

var G__9660 = cljs.core.next.call(null,seq__9643__$1);
var G__9661 = null;
var G__9662 = (0);
var G__9663 = (0);
seq__9643 = G__9660;
...
});})(each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1))
);
});})(each_fixture_fn,G__9642,env,once_fixtures,each_fixtures,vec__9641,ns,vars__$1))
], null);
