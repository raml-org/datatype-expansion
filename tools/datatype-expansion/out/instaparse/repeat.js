...
var args8058 = [];
var len__7095__auto___8063 = arguments.length;
var i__7096__auto___8064 = (0);
while(true){
if((i__7096__auto___8064 < len__7095__auto___8063)){
args8058.push((arguments[i__7096__auto___8064]));

var G__8065 = (i__7096__auto___8064 + (1));
i__7096__auto___8064 = G__8065;
continue;
} else {
}
break;
...
var vec__8061 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__8061,(0),null);
var end = cljs.core.nth.call(null,vec__8061,(1),null);
...
var vec__8062 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__8062,(0),null);
var end = cljs.core.nth.call(null,vec__8062,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$.call(null,end);
} else {
...
var vec__8068 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__8068,(0),null);
var end = cljs.core.nth.call(null,vec__8068,(1),null);
...
var G__8069 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__8069;
continue;
}
...
var args8070 = [];
var len__7095__auto___8077 = arguments.length;
var i__7096__auto___8078 = (0);
while(true){
if((i__7096__auto___8078 < len__7095__auto___8077)){
args8070.push((arguments[i__7096__auto___8078]));

var G__8079 = (i__7096__auto___8078 + (1));
i__7096__auto___8078 = G__8079;
continue;
} else {
}
break;
...
var G__8074 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__8075 = G__8074;
var parse = cljs.core.nth.call(null,vec__8075,(0),null);
var end = cljs.core.nth.call(null,vec__8075,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__8075,(2),null);
var selection = vec__8075;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__8074__$1 = G__8074;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__8076 = G__8074__$1;
var parse__$1 = cljs.core.nth.call(null,vec__8076,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__8076,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__8076,(2),null);
var selection__$1 = vec__8076;
...
var G__8081 = cljs.core.long$.call(null,end__$1);
var G__8082 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__8083 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__8081;
parses__$1 = G__8082;
G__8074__$1 = G__8083;
continue;
...
var args8084 = [];
var len__7095__auto___8091 = arguments.length;
var i__7096__auto___8092 = (0);
while(true){
if((i__7096__auto___8092 < len__7095__auto___8091)){
args8084.push((arguments[i__7096__auto___8092]));

var G__8093 = (i__7096__auto___8092 + (1));
i__7096__auto___8092 = G__8093;
continue;
} else {
}
break;
...
var G__8088 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__8089 = G__8088;
var parse = cljs.core.nth.call(null,vec__8089,(0),null);
var end = cljs.core.nth.call(null,vec__8089,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__8089,(2),null);
var selection = vec__8089;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__8088__$1 = G__8088;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__8090 = G__8088__$1;
var parse__$1 = cljs.core.nth.call(null,vec__8090,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__8090,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__8090,(2),null);
var selection__$1 = vec__8090;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__8095 = cljs.core.long$.call(null,end__$1);
var G__8096 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__8097 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__8095;
parses__$1 = G__8096;
G__8088__$1 = G__8097;
continue;
...
var args8098 = [];
var len__7095__auto___8105 = arguments.length;
var i__7096__auto___8106 = (0);
while(true){
if((i__7096__auto___8106 < len__7095__auto___8105)){
args8098.push((arguments[i__7096__auto___8106]));

var G__8107 = (i__7096__auto___8106 + (1));
i__7096__auto___8106 = G__8107;
continue;
} else {
}
break;
...
var index__$1 = cljs.core.long$.call(null,index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__8102 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__8103 = G__8102;
var parse = cljs.core.nth.call(null,vec__8103,(0),null);
var end = cljs.core.nth.call(null,vec__8103,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__8103,(2),null);
var selection = vec__8103;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__8104 = G__8102__$1;
var parse__$1 = cljs.core.nth.call(null,vec__8104,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__8104,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__8104,(2),null);
var selection__$1 = vec__8104;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__8109 = cljs.core.long$.call(null,end__$1);
var G__8110 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__8111 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__8109;
parses__$1 = G__8110;
G__8102__$1 = G__8111;
continue;
...
var args8112 = [];
var len__7095__auto___8115 = arguments.length;
var i__7096__auto___8116 = (0);
while(true){
if((i__7096__auto___8116 < len__7095__auto___8115)){
args8112.push((arguments[i__7096__auto___8116]));

var G__8117 = (i__7096__auto___8116 + (1));
i__7096__auto___8116 = G__8117;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__6020__auto__ = cljs.core.empty_QMARK_.call(null,header_results);
if(or__6020__auto__){
...
if(cljs.core.truth_((function (){var or__6020__auto__ = (repeat_result instanceof instaparse.gll.Failure);
if(or__6020__auto__){
return or__6020__auto__;
} else {
var and__6008__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser),new cljs.core.Keyword(null,"star","star",279424429));
...
var G__8120 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);
switch (G__8120) {
case "enlive":
...
if(cljs.core.not.call(null,(function (){var and__6008__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207));
if(and__6008__auto__){
var and__6008__auto____$1 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null).call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser));
